...
gallery/backbone-lite/1.0/index

*/
/*=============================================================================
#     FileName: backbone.js
#         Desc: hack backbone for KISSY
#        Email: star212417@163.com
#     HomePage: http://www.quxing.info
#      Version: 0.0.1
#   LastChange: 2013-08-09 11:54:36
#      History:
=============================================================================*/
//     Backbone.js 1.0.0
...
//     http://backbonejs.org
KISSY.add('gallery/backbone-lite/1.0/index',function (S, Node,IO) {
 ...
 */
 _.bind = function(func, context){
  ...
  /* Underscore method end */

  // For Backbone's purposes, jQuery, Zepto, Ender, or My Library (kidding) owns
  // the `$` variable.
  Backbone.$ = Node.all || root.jQuery || root.Zepto || root.ender || root.$;
  Backbone._ = _;
  ...
  // listening to.
  S.each(listenMethods, function(implementation, method) {
  ...
  S.each(modelMethods, function(method) {
  ...
  S.each(attributeMethods, function(method) {
